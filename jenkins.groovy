...
def runSystemTests() {
    sh "mvn -f ${WORKSPACE}/systemtest/pom.xml verify -DjunitTags=acceptance,regression -Djava.net.preferIPv4Stack=true -DtrimStackTrace=false -Dit.test=OpenShiftTemplatesST"
}
